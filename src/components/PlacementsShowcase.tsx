    ...
    <section id="placements" className="py-12 sm:py-16 px-4 bg-[#ffffff] bg-tech-dots border-b border-slate-200/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div className="text-center max-w-lg mx-auto space-y-1">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-[#f0f8ff] text-[#0066cc] text-[10px] font-bold uppercase tracking-[0.14em] border border-blue-200/80 shadow-2xs">
        ...
        <div 
          ...
          className="bg-[#f7f9fc] p-6 sm:p-8 rounded-3xl border border-gray-200/90 space-y-5 shadow-sm overflow-hidden relative"
        >
          {/* Header Strip */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-200/80 pb-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-blue-50 text-[#0066cc] flex items-center justify-center border border-blue-200/60">
            ...
            >
              <div className="flex items-center gap-3 animate-marquee-left shrink-0">
                {[...row1, ...row1, ...row1].map((partner, idx) => (
                  <div
                    key={`r1-${idx}`}
                    className="bg-white border border-gray-200/80 px-4 py-2.5 rounded-xl flex items-center gap-2 text-xs font-bold text-[#1f2937] hover:text-[#0066cc] hover:border-[#0066cc] hover:shadow-md transition-all duration-300 font-sans cursor-pointer group shadow-xs shrink-0"
                  >
                    <span className="w-2 h-2 rounded-full bg-blue-500/40 group-hover:bg-[#0066cc] transition-colors" />
                    <span>{partner}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="pt-2 flex flex-wrap items-center justify-between gap-3 text-xs text-gray-600 border-t border-gray-200/60 font-sans">
