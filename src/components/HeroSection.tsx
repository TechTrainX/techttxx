  ...
  return (
    <section id="hero" className="relative overflow-hidden border-b border-slate-200/80 bg-[#f8fafc]">
      ...
      >
        ...
        {/* Top Bar — location tag left, live-status tag right, hidden on mobile */}
        <div className="absolute inset-x-0 top-0 z-10 hidden items-center justify-between px-6 pt-6 sm:px-10 lg:flex">
          <div className="flex items-center gap-2.5 font-mono text-[10px] uppercase tracking-[0.25em] text-white/70">
            ...
            <span>TechTrainX Labs — Lucknow</span>
          </div>
        ...
        {/* Technical Capability Console — now per-track, not generic filler */}
        <div className="absolute bottom-28 right-6 z-10 hidden w-64 rounded-2xl border border-white/15 bg-[#050d24]/45 p-4 text-white shadow-[0_20px_55px_rgba(0,0,0,0.22)] backdrop-blur-md xl:block">
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <div className="rounded-xl border border-white/10 bg-white/[0.06] p-2.5"><Cpu className="mb-2 h-3.5 w-3.5 text-blue-300" /><span className="block text-[9px] uppercase tracking-[0.12em] text-slate-300">Stack</span><span className="mt-1 block font-mono text-[10px] text-white">{currentVisual.stack}</span></div>
            <div className="rounded-xl border border-white/10 bg-white/[0.06] p-2.5"><Layers className="mb-2 h-3.5 w-3.5 text-blue-300" /><span className="block text-[9px] uppercase tracking-[0.12em] text-slate-300">Format</span><span className="mt-1 block font-mono text-[10px] text-white">{currentVisual.mode}</span></div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 z-10 flex max-w-3xl flex-col justify-center px-6 sm:px-10 lg:px-16">
          ...
          <h1 className="font-luxury-title text-4xl font-light leading-[1.02] tracking-[-0.045em] text-white [text-shadow:0_4px_28px_rgba(0,0,0,0.65)] xs:text-5xl sm:text-6xl lg:text-[76px]">
            Build Projects.
            <br />
            <span className="font-light italic text-blue-300">Defend Them In Interviews.</span>
          </h1>

          <p className="mt-6 hidden max-w-lg font-sans text-base font-light leading-relaxed tracking-wide text-slate-100/90 sm:block">
            Live coding labs. Real IoT hardware. QR-verified certificates. Campus hiring drives.
          </p>
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-2 gap-3 px-4 py-8 sm:grid-cols-4 sm:gap-4 sm:px-6 sm:py-10">
        <div className="group rounded-2xl border border-slate-200/90 bg-white/95 p-3.5 text-center shadow-[0_12px_30px_rgba(15,23,42,0.07)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#0066cc]/60 hover:shadow-[0_18px_38px_rgba(0,102,204,0.14)] sm:p-4">
          <p className="text-xl sm:text-3xl font-luxury-title font-semibold text-[#0066cc]">30</p>
          <p className="mt-0.5 text-[9px] sm:text-[10px] text-slate-500 uppercase tracking-[0.15em] font-sans font-medium">Seat Batches</p>
        </div>
        <div className="group rounded-2xl border border-slate-200/90 bg-white/95 p-3.5 text-center shadow-[0_12px_30px_rgba(15,23,42,0.07)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#0066cc]/60 hover:shadow-[0_18px_38px_rgba(0,102,204,0.14)] sm:p-4">
          <p className="flex items-center justify-center gap-1 text-xl sm:text-3xl font-luxury-title font-semibold text-[#0a0a0f]"><ShieldCheck className="h-4 w-4 text-[#0066cc] sm:h-6 sm:w-6" />100%</p>
          <p className="mt-0.5 text-[9px] sm:text-[10px] text-slate-500 uppercase tracking-[0.15em] font-sans font-medium">Placement Support</p>
        </div>
        <div className="group rounded-2xl border border-slate-200/90 bg-white/95 p-3.5 text-center shadow-[0_12px_30px_rgba(15,23,42,0.07)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#0066cc]/60 hover:shadow-[0_18px_38px_rgba(0,102,204,0.14)] sm:p-4">
          <p className="text-xl sm:text-3xl font-luxury-title font-semibold text-[#0066cc]">5+</p>
          <p className="mt-0.5 text-[9px] sm:text-[10px] text-slate-500 uppercase tracking-[0.15em] font-sans font-medium">Live Labs</p>
        </div>
        <div className="group rounded-2xl border border-slate-200/90 bg-white/95 p-3.5 text-center shadow-[0_12px_30px_rgba(15,23,42,0.07)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#0066cc]/60 hover:shadow-[0_18px_38px_rgba(0,102,204,0.14)] sm:p-4">
          <p className="text-xl sm:text-3xl font-luxury-title font-semibold text-[#0a0a0f]">12+</p>
          <p className="mt-0.5 text-[9px] sm:text-[10px] text-slate-500 uppercase tracking-[0.15em] font-sans font-medium">Hiring Partners</p>
        </div>
      </div>
    </section>
  );
