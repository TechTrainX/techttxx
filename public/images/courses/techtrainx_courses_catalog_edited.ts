...
export const COURSES_DATA: Course[] = [
  {
    ...
    shortDescription: 'MongoDB, Express, React, and Node — learn the main steps of building and deploying a full-stack app.',
    fullDescription: 'A hands-on track for anyone who wants to build with the JavaScript stack: a React front end talking to a real Node/Express API, backed by MongoDB, with auth, deployment, and the deployment and project practices that are useful for beginners.',
    ...
    bannerImage: '/images/courses/techtrainx_course_mern.png',
    technologies: ['React', 'Node.js', 'Express', 'MongoDB', 'TypeScript', 'JWT Auth', 'Redux Toolkit'],
    keyHighlights: [
      'Guided project work with deployment support, according to the batch plan',
      'Regular Git and GitHub practice for maintaining your project work',
      'Auth, validation, and error handling explained through practical examples and project exercises',
  ...
  },
  {
    ...
    fullDescription: 'Starts from zero — no prior coding assumed — and takes you through Python fundamentals, object-oriented design, Django\'s MVT pattern, and a REST API practice backed by PostgreSQL.',
    duration: '6 Weeks (5 Days/Week, 4–5 Hrs Daily)',
    level: 'Beginner',
    price: 5999,
    originalPrice: 9999,
    ...
    bannerImage: '/images/courses/techtrainx_course_python.png',
    ...
    keyHighlights: [
      ...
      'Deployment walkthrough using a Linux-based hosting setup'
    ],
  ...
  },
  {
    ...
    category: 'Programming & Backend',
    shortDescription: 'Core Java, Spring Boot, and Spring Security — built around a guided capstone service.',
    fullDescription: 'Focused on the Java stack used in many software projects: core language fundamentals, Spring Boot REST services, JPA/Hibernate, and Spring Security with JWT, capped by one capstone service built end to end.',
    ...
    bannerImage: '/images/courses/techtrainx_course_java.png',
  ...
  },
  {
    ...
    bannerImage: '/images/courses/techtrainx_course_ai_ml.png',
  ...
  },
  {
    ...
    fullDescription: 'Covers Dart, Flutter\'s widget system, state management, and a Firebase-backed app you build feature by feature, ending with a a release build and an overview of the Play Store process.',
    duration: '6 Weeks',
    level: 'Intermediate',
    price: 5999,
    originalPrice: 9999,
    ...
    bannerImage: '/images/courses/techtrainx_course_flutter.png',
  ...
  },
  {
    ...
    category: 'Programming & Backend',
    shortDescription: 'C#, ASP.NET Core, and Entity Framework — built for students exploring corporate and backend development roles.',
    ...
    bannerImage: '/images/courses/techtrainx_course_dotnet.png',
    ...
    keyHighlights: [
      ...
      'EF Core migrations done hands-on against a a SQL Server database setup',
